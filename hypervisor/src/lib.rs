...
// Test modules are linted too (see `clippy` in the Makefile). These three fire
// only inside `#[cfg(test)]`, and fixing them would cost more than it buys:
//
//   identity_op                  `(0u64 << 24) | 0b101`, `(intid << 16) | 0`.
