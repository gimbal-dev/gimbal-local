...
The expected SHA-256 comes from Ubuntu's
...
and matches the package currently served by Ubuntu's HTTPS ports archive.
Do not extract or boot the package unless `shasum` reports `OK`.
